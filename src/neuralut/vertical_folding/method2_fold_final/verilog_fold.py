...
def layer_connection_verilog(layer_string: str, input_string: str, input_bits: int, output_string: str, output_bits: int, fold: bool, output_wire=True, register=False):
    if register:
...
def generate_neuron_connection_verilog(input_indices, input_bitwidth, fold):
    connection_string = ""
