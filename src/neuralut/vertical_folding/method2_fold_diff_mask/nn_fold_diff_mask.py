        ...
        if type(module) == SparseLinearNeq:
            ...
            if verbose:
                if module.folding_factor == 1:
                    ...
                    print(
                        f"Truth tables generated for {len(module.neuron_truth_tables)/module.folding_factor} neurons"
                    )
...
class SparseLinearNeq(nn.Module):
        ...
        for i in range(self.out_features):
            if num_iter == -1:
                ...
                (
                    ...
                    float_output_states,
                    bin_output_states,
                ) = self.neuron_truth_tables[num_iter * self.out_features + i]
            if self.cuda:
    ...
    def forward(self, x: Tensor, num_iter: int) -> Tensor:
